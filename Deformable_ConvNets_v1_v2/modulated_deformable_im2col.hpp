#ifndef _CAFFE_UTIL_MODULATED_DEFORMABLE_IM2COL_HPP_
#define _CAFFE_UTIL_MODULATED_DEFORMABLE_IM2COL_HPP_
...
template <typename Dtype>
void modulated_deformable_col2im_gpu(const Dtype* data_col, const Dtype* data_offset, const Dtype* data_mask, const int channels,
